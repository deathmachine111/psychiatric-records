  ...
  {:else}
    <div class="space-y-2">
      {#each files as file (file.id)}
        <button type="button" class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition cursor-pointer w-full text-left" on:click={() => handleSelectFile(file)}>
